...
#     --root_datasets_dir /media/wriva/Data/WACV25/dev_phase/dev_contest_datasets_241207/ \
...
# Run the Python script
# python3 ultrra-baseline/baseline.py --stage view_synthesis \
#     --root_datasets_dir /media/wriva/Data/WACV25/test_phase/test_contest_datasets_241207/ \
